...
public class SongListAdapter extends RecyclerView.Adapter<SongListAdapter.ViewHolder> implements ListItemClickListener{

    private ArrayList<Song> mListSongs;
    Context mContext;
    final private ListItemClickListener mOnClickListener;

    public SongListAdapter(ArrayList<Song> listSongs, ListItemClickListener onClickListener) {
